...
//     const texts = {
//         beginner: "This is a simple typing test.",
//         intermediate: "Typing tests are useful for improving your typing speed and accuracy.",
//         advanced: "Achieving high typing speeds requires consistent practice and a focus on reducing errors."
//     };
...
//         const errors = countErrors(text, typedText);
//         const accuracy = Math.max(0, 100 - Math.round((errors / text.length) * 100));
...
//     function countErrors(text, typedText) {
//         let errors = 0;
...
//     function savePerformance(wpm) {
//         performanceData.push(wpm);
//         localStorage.setItem('performanceData', JSON.stringify(performanceData));
//         updateChart(performanceData);
//         savePerformanceToDatabase(wpm);
//     }

//     function savePerformanceToDatabase(wpm) {
//         const performanceRef = database.ref('performances').push();
//         performanceRef.set({
//             wpm: wpm,
//             timestamp: Date.now()
//         });
